...
一个人运营内容账号，AI 能写，但写出来的东西有四个老毛病：

- 事实来路不明，转载当独家，备案当上线；
- AI 味重——同一改判句式连用、反问连发、对读者俯视说教；
- 图不可读、权利不清，官方大表原图一贴了事；
- 质量全靠当天状态，没有可重复的流程，错误反复出现。

press-fleet 把新闻编辑部的纪律拆成可执行的机制：**信号进（信息源雷达 + 读者反馈）→ 选题台 → 证据层 → 六角色生产流水线 → 确定性门禁 → 用户授权发布 → 复盘 → SOP 改版**。
